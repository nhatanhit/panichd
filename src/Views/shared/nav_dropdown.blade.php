<ul class="dropdown-menu">
	...
	<a class="dropdown-item {!! $tools->fullUrlIs(action('\PanicHD\PanicHD\Controllers\GameController@index').'*') ? "active" : "" !!}" href="{{ action('\PanicHD\PanicHD\Controllers\GameController@index') }}">{{ trans('game.nav-game') }}</a>
